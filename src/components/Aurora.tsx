...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    console.log('Aurora: Renderer created', { width: ctn.offsetWidth, height: ctn.offsetHeight });
    ...
    function resize() {
      ...
      console.log('Aurora: Resizing', { width, height });
    ...
    console.log('Aurora: Canvas appended', gl.canvas);
