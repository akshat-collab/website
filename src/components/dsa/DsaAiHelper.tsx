...
export function DsaAiHelper({ problemContext, userCode, language, problemId }: DsaAiHelperProps) {
 ...
 <div className="relative w-24 h-24 rounded-full bg-gradient-to-b from-neutral-500/20 to-neutral-500/20 flex items-center justify-center border border-border shadow-[0_0_30px_rgba(6,182,212,0.2)]">
 <Bot className="h-12 w-12 text-foreground drop-shadow-none" />
 <div className="absolute inset-0 rounded-full bg-foreground/10 animate-pulse" />
 </div>
 </div>
 ...
 <span className="text-xs font-bold text-foreground uppercase tracking-widest">DSA Buddy</span>
 </div>
 ...
 className="w-full text-left px-4 py-2.5 rounded-xl bg-muted/80 hover:bg-foreground/10 border border-border/60 hover:border-border text-sm text-muted-foreground hover:text-foreground transition-all duration-300"
 >
 {action}
 </button>
 ))}
 ...
 <span className="text-[10px] font-bold text-foreground uppercase tracking-wider">DSA Buddy</span>
 </div>
 )}
 ...
 disabled={isLoading}
 className="w-full bg-background text-sm text-foreground placeholder:text-muted-foreground rounded-xl pl-4 pr-20 py-3 border border-border focus:outline-none focus:border-foreground/30 focus:ring-1 focus:ring-foreground/30 transition-all disabled:opacity-50"
 />
 ...
 className="h-8 w-8 bg-foreground hover:bg-foreground text-black rounded-lg shadow-none disabled:opacity-50"
 >
