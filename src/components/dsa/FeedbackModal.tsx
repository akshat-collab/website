...
export function FeedbackModal({ open, onOpenChange, problemSlug }: FeedbackModalProps) {
 ...
 className="w-full h-32 bg-muted text-sm text-foreground placeholder:text-muted-foreground rounded-xl p-3 border border-border focus:outline-none focus:border-foreground/30 focus:ring-1 focus:ring-foreground/30 transition-all resize-none"
 maxLength={2000}
 />
