...
export function DsaSidebar({ className }: { className?: string }) {
 ...
 "bg-slate-50 dark:bg-[#000000] border-slate-200 dark:border-white/10",
 className
 )}>
 {/* Logo Section */}
 ...
 difficulty === level && "bg-foreground/10 border border-border"
 )} 
 ...
 className={cn(
 "flex items-center space-x-3 group cursor-pointer px-2 py-1.5 rounded-md transition-all",
 status === s.value && "bg-foreground/10 border border-border"
 )} 
 ...
 "bg-white dark:bg-[#0a0a0a] border-slate-200 dark:border-white/10 focus-visible:ring-foreground/30 focus-visible:border-foreground/30 text-slate-900 dark:text-white"
 )} 
 />
 </div>
 </SidebarSection>
 ...
 "border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#000000]"
 )}>
 <Link
 to="/dsa/problems"
 className={cn(
