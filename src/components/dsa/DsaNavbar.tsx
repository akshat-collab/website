...
export function DsaNavbar() {
 ...
 return (
 <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-[#000000]/80 backdrop-blur-xl">
 ...
 <DropdownMenuContent align="end" className="w-56 bg-[#000000] border-white/10 text-white">
 ...
 <Button size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-none">Register</Button>
 </Link>
 </div>
 )}
 ...
 {/* Mobile Menu */}
 {mobileOpen && (
 <div className="md:hidden border-t border-white/10 bg-[#000000] p-4 flex flex-col gap-2 absolute w-full left-0 top-16 shadow-2xl animate-in slide-in-from-top-5">
 {navLinks.map(({ to, label, icon: Icon }) => (
 <Link
 key={to}
 to={to}
